...
class GoogleCloudContactcenterinsightsV1alpha1LossPattern extends \Google\Collection
{
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1LossPattern::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1LossPattern');
