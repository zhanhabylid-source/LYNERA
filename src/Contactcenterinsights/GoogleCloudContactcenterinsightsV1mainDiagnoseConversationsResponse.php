...
class GoogleCloudContactcenterinsightsV1mainDiagnoseConversationsResponse extends \Google\Collection
{
  ...
  protected $fullTrajectoryStepsType = GoogleCloudContactcenterinsightsV1mainSherlockStep::class;
   ...
   * agent.
   *
   * @param GoogleCloudContactcenterinsightsV1mainSherlockStep[] $fullTrajectorySteps
   */
...
class_alias(GoogleCloudContactcenterinsightsV1mainDiagnoseConversationsResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1mainDiagnoseConversationsResponse');
