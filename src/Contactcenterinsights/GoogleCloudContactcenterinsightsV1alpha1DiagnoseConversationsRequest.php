...
class GoogleCloudContactcenterinsightsV1alpha1DiagnoseConversationsRequest extends \Google\Model
{
  /**
   ...
   */
  public $metricType;
  protected $outputConfigType = GoogleCloudContactcenterinsightsV1alpha1OutputConfig::class;
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1DiagnoseConversationsRequest::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1DiagnoseConversationsRequest');
