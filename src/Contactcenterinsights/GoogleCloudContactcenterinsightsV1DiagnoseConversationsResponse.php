...
class GoogleCloudContactcenterinsightsV1DiagnoseConversationsResponse extends \Google\Collection
{
  ...
  protected $fullTrajectoryStepsType = GoogleCloudContactcenterinsightsV1SherlockStep::class;
   ...
   * agent.
   *
   * @param GoogleCloudContactcenterinsightsV1SherlockStep[] $fullTrajectorySteps
   */
...
class_alias(GoogleCloudContactcenterinsightsV1DiagnoseConversationsResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1DiagnoseConversationsResponse');
